...
LAYERS = [1, 6, 11, 18] # Couches du réseau importés VGG19 qui sont utilisées dans la loss
MEAN   = [0.485, 0.456, 0.406] #moyenne imagenet
STD    = [0.229, 0.224, 0.225] #std imagenet

PRESET = 0 # Réglage des filtres. 0 correspond aux réglages standard de l'article. Il est possible de le changer pour tester les hypothèses de l'article.
